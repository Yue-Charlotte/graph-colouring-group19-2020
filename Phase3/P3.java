...
{	
    ...
    public static void RunGraphAlgorithm(Graph g)
    {      
        ...
        System.out.println("Upper: " + upper);
				...
				System.out.println("Graph bipartite? " + bipartite.result);
				
				// If graph is bipartite then we can safely assume the chromatic number is 2
				if (bipartite.result){
					FinalResult(2);
					System.exit(0);
				}
		...
		public static void FinalResult(int x){
