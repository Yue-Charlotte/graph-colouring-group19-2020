...
public class MaxCliq 
{
    ...
    public MaxCliq(int[][] inputmatrix)
    {
        ...
        this.maxCliq = 0;
				...
				Group19Phase2.gameManager.GameChromaticNumber(1, maxCliq);
    }
	...
	ArrayList<Integer> Collection = new ArrayList<Integer>();
        ...
        //Run core method
        //This updates the maxCliq variable with the largest completed subgraph
    ...
    private void MaxCliqIteration(ArrayList<Integer> VertexSet, ArrayList<Integer> CompleteGraphVertices)
    {
        try
        {
            while(VertexSet.size() > 0)
            {
                ...
                //Quit loop if there are not enough vertices left to create a bigger cliq
