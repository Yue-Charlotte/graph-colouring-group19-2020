...
public class HintPopupJFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		cni.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Hint/cni1.png"))); // NOI18N
		...
		crv.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Hint/crv1.png"))); // NOI18N
	...
	public void ColorNumberCheck() {
		...
		if(playerColorNumbers > chromaticNumber) {  //playerColorNumbers: currently how many colors are used, chromaticNumber : true answer
			...
			JOptionPane.showMessageDialog(this,"You still have at least "+ (chromaticNumber-playerColorNumbers) + " color(s) available to use.");
		}
	...
	public void assignNewColor() {
		...
		// Fix by Christopher
		if (amountOflinkedVertex == 0){
			shareSameColorOrNot = false;
			colorRandomVertex(c);
		}
		...
		for(int i=1;i < amountOflinkedVertex; i++) {
		 shareSameColorOrNot = Group19Phase2.G.CheckEdgeColouring(randomVertex,linkedVertex.get(i));//check if they have same color or not
			...
			// Fix by Christopher
			if ((Group19Phase2.G.GetVertexColour(randomVertex) == -1) || (Group19Phase2.G.GetVertexColour(i) == -1 )) {
				shareSameColorOrNot = false;
			}
